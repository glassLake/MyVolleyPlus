...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    public boolean isForceGetNet() {
        return forceGetNet;
    }

    public void setForceGetNet(boolean forceGetNet) {
        this.forceGetNet = forceGetNet;
    }

    protected boolean forceGetNet;//是否強制訪問網絡而忽略緩存,初始化為true
